...
#include "Mutator.h"
#include "PerturbPropertyInDecoratorMutator.generated.h"

/**
 * @file PerturbPropertyInDecoratorMutator.h
 */

/**
 * @class UPerturbPropertyInDecoratorMutator
 * @author npcdev
 * @date 10/18/21
 * @brief Randomly modifies a property value in a generated decorator node.
 *
...
UCLASS()
class EVOLVINGBEHAVIOR_API UPerturbPropertyInDecoratorMutator : public UMutator
{
    GENERATED_BODY()
