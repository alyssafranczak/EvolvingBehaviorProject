...
#include "Mutator.h"
#include "PerturbPropertyInTaskMutator.generated.h"

/**
 * @file PerturbPropertyInTaskMutator.h
 */

/**
 * @class UPerturbPropertyInTaskMutator
 * @author npcdev
 * @date 10/18/21
 * @brief Randomly modifies a property value in a generated task node.
 * 
...
UCLASS()
class EVOLVINGBEHAVIOR_API UPerturbPropertyInTaskMutator : public UMutator
{
    GENERATED_BODY()
