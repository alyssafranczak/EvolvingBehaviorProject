...
UBTChromosome*
URemoveGeneratedDecoratorMutator::Mutate( UBTChromosome* chromosome, TArray<UBTChromosome*> parents, int primaryParent )
{
    ...
    BTChromosomeUtils::FindRandomNodeOfType(
        chromosome, rand, UBTGeneratedDecoratorGene::StaticClass(), parent, childIdx, decoratorNode );
